...
@ssh -i /cygdrive/c/BlockWorks/Build/Common/PrivateKey %BLOCKWORKS_BUILDVM_USERHOST% "export BLOCKWORKS_PLATFORM_BASE=%TARGET_PLATFORM_BASE% && cd %TARGET_CWD% && make %* "
